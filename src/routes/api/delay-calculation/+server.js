...
export async function GET() {
    ...
    const arrivalsHoorn = JSON.parse(await readFile(join(base, 'static/data/arrivalsHoorn.json')));
    const arrivalsAmsterdam = JSON.parse(await readFile(join(base, 'static/data/arrivalsAmsterdam.json')));
    const departuresHoorn = JSON.parse(await readFile(join(base, 'static/data/departuresHoorn.json')));
    const departuresAmsterdam = JSON.parse(await readFile(join(base, 'static/data/departuresAmsterdam.json')));
